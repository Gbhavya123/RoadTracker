                  ...
                  <div className="relative">
                    ...
                    {dropdownOpen && (
                      <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-900 rounded-xl shadow-xl border border-gray-200 dark:border-gray-800 z-50 animate-fade-in flex flex-col py-2">
                        ...
                        <button onClick={() => { setDropdownOpen(false); navigate(authRole === 'admin' ? '/dashboard/admin' : '/dashboard/user'); }} className="px-4 py-2 text-left hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-colors text-gray-800 dark:text-gray-100">Dashboard</button>
          ...
          <div className="md:hidden py-4 border-t border-border animate-in slide-in-from-top-2 duration-200">
            ...
            {isAuthenticated && (
              <div className="flex flex-col gap-1 px-4 pb-2">
                ...
                <button
                  onClick={() => { setIsMenuOpen(false); navigate(authRole === 'admin' ? '/dashboard/admin' : '/dashboard/user'); }}
                  className="w-full text-left px-3 py-2 rounded-lg text-sm font-medium text-gray-800 dark:text-gray-100 hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-colors"
                >
                  Dashboard
                </button>
