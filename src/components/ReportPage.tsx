...
const ReportPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-500 py-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Tips Card */}
        <div className="bg-blue-50 dark:bg-gray-900 rounded-xl p-6 mt-4 text-left shadow border border-blue-100 dark:border-gray-700">
