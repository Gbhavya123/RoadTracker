...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen scroll-smooth">
      {/* Hero Section */}
      <section id="hero" className="relative min-h-screen flex items-center bg-gradient-to-br from-blue-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 py-20 overflow-hidden">
      ...
      {/* How It Works */}
      <section id="how-it-works" className="min-h-screen flex items-center py-20 bg-white dark:bg-gray-900 transition-colors duration-500">
      ...
      {/* Features Grid */}
      <section id="features" className="relative min-h-screen flex flex-col items-center justify-start py-8 md:py-16 bg-gradient-to-br from-white via-gray-100 to-gray-200 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 transition-colors duration-500 overflow-hidden">
      ...
      {/* Map Preview */}
      <section id="map" className="min-h-screen flex items-center py-20 bg-white dark:bg-gray-900 transition-colors duration-500">
      ...
      {/* FAQ Section */}
      <section id="faq" className="min-h-screen flex items-center bg-white dark:bg-gray-900 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center mb-2" style={{ color: 'transparent', background: 'linear-gradient(90deg, #ff9800, #ffb347)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>FAQs</h2>
          <p className="text-center text-gray-500 mb-12">Here are some of the basic FAQs for you to have a look at!</p>
          <div className="space-y-4">
            {/* FAQ Item */}
            {[{
              q: 'What is RoadTracker?',
              a: 'RoadTracker is a platform for reporting and tracking road issues in your community.'
            }, {
              q: 'How does RoadTracker work?',
              a: 'Users can report issues, track their status, and view them on a live map. Admins verify and resolve reports.'
            }, {
              q: 'Who can use RoadTracker?',
              a: 'Anyone can report issues. Admins are responsible for managing and resolving them.'
            }, {
              q: 'Is RoadTracker free to use?',
              a: 'Yes, RoadTracker is free for all users.'
            }, {
              q: 'Can I track the status of my report?',
              a: 'Yes, you can track your report from submission to resolution in your dashboard.'
            }].map((faq, idx) => (
              <details key={idx} className="bg-white dark:bg-gray-800 rounded-lg shadow p-4 group">
                <summary className="cursor-pointer text-lg font-medium text-gray-800 dark:text-gray-100 flex justify-between items-center">
                  {faq.q}
                  <span className="ml-2 transition-transform group-open:rotate-180">▼</span>
                </summary>
                <div className="mt-2 text-gray-600 dark:text-gray-300 animate-fade-in">
                  {faq.a}
                </div>
              </details>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-6 md:flex md:flex-row md:items-start md:justify-between md:gap-12">
            ...
            <div className="flex flex-col items-start">
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2 text-base sm:text-lg">QUICK LINKS</h4>
              <ul className="space-y-1 text-gray-600 dark:text-gray-300 text-sm">
                <li><a href="/" className="hover:underline">Home</a></li>
                <li><a href="/report" className="hover:underline">Report Issue</a></li>
                <li><a href="/map" className="hover:underline">Live Map</a></li>
            ...
            {/* Follow Us */}
            <div className="flex flex-col items-start">
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2 text-base sm:text-lg">FOLLOW US</h4>
              <ul className="space-y-1 text-gray-600 dark:text-gray-300 text-sm">
            ...
            {/* Contact */}
            <div className="flex flex-col items-start">
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2 text-base sm:text-lg">CONTACT</h4>
              <ul className="space-y-1 text-gray-600 dark:text-gray-300 text-sm">
                <li><a href="https://www.linkedin.com/in/anujshrivastava1/" target="_blank" rel="noopener noreferrer" className="hover:underline">Anuj Shrivastava</a></li>
                <li><a href="https://www.linkedin.com/in/divyansh-agrawal-4556a0299/" target="_blank" rel="noopener noreferrer" className="hover:underline">Divyansh Agrawal</a></li>
                <li><a href="https://www.linkedin.com/in/bhavya-gupta-88664128a/" target="_blank" rel="noopener noreferrer" className="hover:underline">Bhavya Gupta</a></li>
                <li><a href="https://www.linkedin.com/in/anuragvishwakarma/" target="_blank" rel="noopener noreferrer" className="hover:underline">Anurag Vishwakarma</a></li>
              </ul>
            </div>
            {/* Legal */}
            <div className="flex flex-col items-start">
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2 text-base sm:text-lg">LEGAL</h4>
              <ul className="space-y-1 text-gray-600 dark:text-gray-300 text-sm">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between text-gray-500 dark:text-gray-400 text-xs gap-2 sm:gap-0">
            <div className="text-center md:text-left w-full md:w-auto">© {new Date().getFullYear()} RoadTracker. All Rights Reserved.</div>
            <div className="flex gap-3 sm:gap-4 mt-2 md:mt-0 items-center justify-center">
              <a href="#" className="hover:text-blue-500 flex items-center" aria-label="WhatsApp">
                <svg width="28" height="28" viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.5" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="16" cy="16" r="15" stroke="#6B7280" strokeWidth="2" fill="none"/>
                  <path d="M22.2 18.7c-.3-.2-1.7-.8-2-1-0.3-.1-.5-.2-.7.2-.2.3-.7 1-0.9 1.2-.2.2-.3.2-.6.1-.3-.1-1.2-.4-2.3-1.4-.9-.8-1.4-1.7-1.6-2-.2-.3 0-.4.1-.6.1-.1.3-.3.4-.5.1-.2.2-.3.3-.5.1-.2.1-.4 0-.5-.1-.1-.6-1.5-.8-2-.2-.5-.5-.5-.7-.5-.2 0-.4 0-.6 0-.2 0-.5.1-.8.3-.3.3-1 1-1 2.4 0 1.4 1 2.8 1.2 3 .2.2 2.1 3.2 5 4.3.7.3 1.2.5 1.7.6.7.2 1.3.2 1.8.1.6-.1 1.7-.7 1.9-1.3.2-.6.2-1.2.1-1.3-.1-.1-.3-.2-.5-.3z" fill="#6B7280"/>
                </svg>
              </a>
              <a href="https://github.com/" className="hover:text-blue-500 flex items-center" aria-label="GitHub">
                <svg width="28" height="28" fill="currentColor" className="inline" viewBox="0 0 20 20"><path d="M10 0C4.477 0 0 4.477 0 10c0 4.418 2.865 8.166 6.839 9.489.5.092.682-.217.682-.483 0-.237-.009-.868-.014-1.703-2.782.604-3.369-1.342-3.369-1.342-.454-1.154-1.11-1.462-1.11-1.462-.908-.62.069-.608.069-.608 1.004.07 1.532 1.032 1.532 1.032.892 1.529 2.341 1.088 2.91.832.091-.647.35-1.088.636-1.339-2.221-.253-4.555-1.111-4.555-4.944 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.272.098-2.65 0 0 .84-.269 2.75 1.025A9.564 9.564 0 0 1 10 4.844c.85.004 1.705.115 2.504.337 1.909-1.294 2.748-1.025 2.748-1.025.546 1.378.202 2.397.1 2.65.64.699 1.028 1.592 1.028 2.683 0 3.842-2.337 4.687-4.566 4.936.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.749 0 .268.18.579.688.481C17.138 18.163 20 14.418 20 10c0-5.523-4.477-10-10-10z"/></svg>
              </a>
            </div>
          </div>
        </div>
